...
export const PhotoGallery = () => {
    const images = [
        // { foto: require('../../foto/stol-jee/IMG-3c708b964dad50588f2957097d8c0bf3-V.jpg'), alt: 'Photo 1' },
        ...
        // { foto: require(''), alt: 'Photo 15' },
        // { foto: require(''), alt: 'Photo 16' },
        // { foto: require(''), alt: 'Photo 17' },
        // { foto: require(''), alt: 'Photo 18' },
        // { foto: require(''), alt: 'Photo 19' },
        // ...другие фотографии
    ];
